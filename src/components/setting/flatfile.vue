<template>
  <div class="setting">
    ...
    <input name="filename" type="text" placeholder="未命名" />
    <label for="flat">
      分隔符:
    </label>
    <select name="flat">
    ...
    <select name="encoding">
      <option v-for="item in encoding">{{item}}</option>
    </select>
    <div class="button">
      <button class="btn confirm">导出</button>    <button class="btn cancel">取消</button>
    </div>
  </div>
</template>
<script>
